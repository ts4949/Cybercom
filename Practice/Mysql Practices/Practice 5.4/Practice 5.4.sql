...
INSERT INTO orders (order_id, customer_id, order_date, order_total) VALUES
    ...
    (2, 2, '2022-01-15', 75.25), 
    (3, 3, '2022-02-01', 100.00), 
    (4, 4, '2022-02-15', 120.50),
    (5, 5, '2022-03-01', 80.75), 
    (6, 6, '2022-03-15', 95.00), 
    (7, 7, '2022-04-01', 60.25), 
    (8, 8, '2022-04-15', 110.00),
    (9, 9, '2022-05-01', 85.50), 
    (10, 10, '2022-05-15', 70.00);
...
#	Write a SQL query to retrieve the names of all customers who have made at least one order in the "orders" table 
