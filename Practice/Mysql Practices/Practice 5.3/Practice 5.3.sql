...
#	Write a SQL query to retrieve the names and salaries of all employees who have a salary 
...
#	Write a SQL query to retrieve the names and total revenue generated by all customers in the "orders" table, 
...
#	Write a SQL query to retrieve the names and total revenue generated by all customers in the "orders" table, 
#	sorted by revenue in descending order, where the total revenue is greater than the average revenue 
#	generated by all customers, and the customer is from the "USA" or "Canada".
...
#	Write a SQL query to retrieve the names of all employees who have made sales greater than the average sales 
...
#	Write a SQL query to retrieve the names and total revenue generated by all customers in the "orders" table, 
#	sorted by revenue in descending order, where the customer is from the "USA" and the revenue is greater than the average revenue generated by all customers from the "USA".
